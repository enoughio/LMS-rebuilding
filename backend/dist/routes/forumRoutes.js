...
import { getForumPosts, getForumPostById, createForumPost, updateForumPost, deleteForumPost, addForumComment, updateForumComment, getForumComments, toggleForumPostLike, deleteForumComment, getCatagories, } from "../controllers/forumControllers.js";
...
router.delete("/deletecomment/:commentId", verifyToken, authenticate, deleteForumComment); //public route to delete a comment on a forum post
