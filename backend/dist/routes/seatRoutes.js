...
import { getLibrarySeats, getSeatAvailability, createSeat, updateSeat, deleteSeat, bookSeat, getUserBookings, cancelBooking, } from '../controllers/seatController.js';
...
router.post('/library/:libraryId/seats', authorizeRoles([UserRole.ADMIN, UserRole.SUPER_ADMIN]), createSeat);
// Update seat details (Admin only)
router.put('/seats/:seatId', authorizeRoles([UserRole.ADMIN, UserRole.SUPER_ADMIN]), updateSeat);
// Delete a seat (Admin only)
router.delete('/seats/:seatId', authorizeRoles([UserRole.ADMIN, UserRole.SUPER_ADMIN]), deleteSeat);
// Book a seat
