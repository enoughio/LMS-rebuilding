...
import { getLibraryMembershipPlans, createMembershipPlan, updateMembershipPlan, deleteMembershipPlan, purchaseMembership, getUserMemberships, cancelMembership, renewMembership, } from '../controllers/membershipController.js';
...
router.post('/library/:libraryId/plans', authorizeRoles([UserRole.ADMIN, UserRole.SUPER_ADMIN]), createMembershipPlan);
// Update a membership plan (Admin only)
router.put('/plans/:planId', authorizeRoles([UserRole.ADMIN, UserRole.SUPER_ADMIN]), updateMembershipPlan);
// Delete a membership plan (Admin only)
router.delete('/plans/:planId', authorizeRoles([UserRole.ADMIN, UserRole.SUPER_ADMIN]), deleteMembershipPlan);
