...
export const getLibraryRegistrationTemplate = (data) => {
...
export const getLibraryApprovalTemplate = (data) => {
    const { userName, libraryName } = data;
    return {
...
export const getLibraryRejectionTemplate = (data) => {
...
export const getSeatBookingConfirmationTemplate = (data) => {
...
export const getSeatBookingCancellationTemplate = (data) => {
