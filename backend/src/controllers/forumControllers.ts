...
export const createForumPost = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const getCatagories = async (_req: Request, res: Response) => {
  try {
 ...
 * Update a forum post
 */
export const updateForumPost = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
