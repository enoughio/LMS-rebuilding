...
import { Library, OpeningHour } from "@/types/library";// Import shared interface

export default function LibraryCard({ libraries }: { libraries: Library[] }) {
  ...
  const getOpeningHoursDisplay = (openingHours: OpeningHour[]) => {
    if (!openingHours || openingHours.length === 0) return 'Open';
  ...
  return (
    <div className="flex flex-col gap-4">
      {libraries.map((lib) => (
        <div
          key={lib._id} // Using _id as it's always present
            ...
            <div className="flex flex-col sm:flex-row justify-between w-full">
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2 text-sm text-gray-700">
                  {lib.amenities?.map((amenity, index) => (
              ...
              <div className="flex flex-col md:flex-row md:items-end md:justify-end md:mt-1 mt-2 w-full">
                ...
                <div className="hidden md:flex flex-col items-end gap-2">
                  ...
                  <Link href={`/libraries/${lib.id || lib._id}`}>
