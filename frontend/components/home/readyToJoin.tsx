...
export default function Ready() {
  return (
      ...
      <div className="grid grid-cols-2 gap-[1rem] sm:gap-[1.5rem] lg:gap-[2.5rem] max-w-4xl mx-auto">
        {/* Individual Card */}
        <div className="bg-[#E8D5C6] rounded-xl p-[0.75rem] text-left sm:p-[1.5rem] lg:p-[2rem] shadow-md">
          <Image
            src="/indi1.png"
            alt="Individual"
            width={50}
        ...
        <div className="bg-[#FBF5E9] rounded-xl p-[0.75rem] sm:p-[1.5rem] lg:p-[2rem] shadow-md">
          <Image
           ...
           className="w-[1.5rem] sm:w-[2rem] md:w-[2.5rem] lg:w-[3rem] xl:w-[3.5rem] h-auto"
          />
           <p className="mt-[1rem] text-[0.6rem] sm:text-[0.875rem]  md:text-[1.4rem]  font-normal leading-[0.625rem] sm:leading-[1rem] tracking-[-0.04em] text-left">
            Are you a business?
          </p>
           <p className="mt-[0.5rem] sm:mt-[0.75rem] text-gray-600 text-[0.5rem] sm:text-[0.625rem] md:text-[0.875rem]  font-normal leading-[0.7rem] sm:leading-[0.625rem] text-left md:leading-[1.25rem] tracking-[-0.02em]">
            Keep everything that’s important to you and your family shareable and safe in one place.
          </p>
