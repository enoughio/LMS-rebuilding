...
export default function PostItem({
  ...
  return (
    <Card className="overflow-hidden mb-4 hover:shadow-lg shadow-md transition-shadow bg-[#EFEAE5]">
      ...
      <CardContent className="p-4">
        <Link href={`/forum/${id}`} className="block">
          ...
          <p className="text-gray-600 line-clamp-2">{truncateContent(plainTextContent)}</p>
        </Link>
