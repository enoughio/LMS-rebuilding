      ...
      try {
        ...
        if (seatTypesResponse.ok) {
          ...
          if (seatTypesData.success) {
            ...
            console.warn(
              "Seat types fetch unsuccessful:",
              seatTypesData.message
            );
            setSeatTypes([]);
          }
        } else {
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2 text-muted-foreground">
                ...
                <div className="flex items-center">
                  ...
                  <span>
                    {(library.rating || 0).toFixed(1)} (
                    {library.reviewCount || 0} reviews)
                  </span>
                </div>
              </div>
            </div>
                ...
                <Image
                  src={
                    (library.images && library.images.length > 0
                      ? library.images[activeImageIndex]
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 ">
            <div className="lg:col-span-2">
              <Tabs defaultValue="overview">
                <TabsList className="mb-4 rounded-lg sm:gap-2 bg-amber-50/30 shadow-sm">
                  <TabsTrigger
                    className="border-2 text-xs p-1.5  sm:text-xl"
                    value="overview"
                  >
                    Overview
                  </TabsTrigger>
                ...
                <TabsContent value="overview" className="space-y-4">
                  <div className=" rounded-lg bg-amber-50/30 shadow-sm p-4">
                    ...
                    <div className="mt-2 flex items-center gap-4">
                      <div className="flex flex-col items-center text-2xl ">
                        <p className="text-3xl font-bold">
                          {seatTypes.reduce(
                            (total, seatType) =>
                              total + (seatType.availableSeats || 0),
                            0
                          )}
                        </p>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Choose from different seat types based on your needs
                      </p>
                    </div>
                    ...
                    {seatTypes.length > 0 ? (
                            ...
                            <CardContent className="space-y-3">
                              ...
                              <div className="flex items-center gap-4 text-sm">
                                <div className="flex items-center gap-2 text-muted-foreground">
                                  ...
                                  <span>
                                    Available: {seatType.availableSeats || 0}
                                  </span>
                                </div>
                                <div className="flex items-center gap-2 text-muted-foreground">
                            ...
                            <CardFooter>
                              <Button
                                ...
                                onClick={() => {
                                  ...
                                  router.push(
                                    `/libraries/${id}/book-seat?seatType=${seatType.id}`
                                  );
                                }}
                              >
                                {(seatType.availableSeats || 0) === 0
                                  ? "Fully Booked"
                                  : `Book ${seatType.name}`}
                              </Button>
                            </CardFooter>
                      ...
                      <div className="flex flex-col items-center justify-center py-8 text-center">
                        ...
                        <p className="text-muted-foreground">
                          This library hasn&apos;t configured any seat types
                          yet.
                        </p>
                      </div>
                    )}
                ...
                <TabsContent value="amenities" className="space-y-4">
                  {library.amenities && library.amenities.length > 0 ? (
                    <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
                      {library.amenities.map((amenity: string) => {
                        ...
                        const amenityKey = amenity
                          .toLowerCase()
                          .replace(/\s+/g, "_") as LibraryAmenity;
                    ...
                    <div className="flex flex-col items-center justify-center py-8 text-center">
                      ...
                      <p className="text-muted-foreground">
                        This library hasn&apos;t added any amenity information
                        yet.
                      </p>
                    </div>
                  )}
                ...
                <TabsContent value="hours" className="space-y-4">
                  ...
                  Array.isArray(library.openingHours) ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-8 text-center">
                      ...
                      <p className="text-muted-foreground">
                        Contact the library for their operating hours.
                      </p>
                    </div>
                  )}
                </TabsContent>
                ...
                <CardContent className="space-y-4">
                  ...
                  library.membershipPlans.length > 0 ? (
                      ...
                      <div key={plan.id} className="rounded-lg border p-4">
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            router.push(
                              `/libraries/${id}/membership?plan=${plan.id}`
                            );
                          }}
                        >
                    ...
                    <div className="flex flex-col items-center justify-center py-8 text-center">
                      ...
                      <p className="text-muted-foreground">
                        This library hasn&apos;t configured any membership plans
                        yet.
                      </p>
                    </div>
                  )}
                ...
                <CardContent className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">
                      ...
                      {seatTypes.reduce(
                        (total, seatType) => total + (seatType.totalSeats || 0),
                        0
                      )}
                    </span>
                  </div>
