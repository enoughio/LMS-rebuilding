...
// import { Plus, Search, Loader2, FilterX, Newspaper, LucideArrowUpLeftSquare } from 'lucide-react';
...
//   const tabs: { name: 'hot' | 'new' | 'top'; icon: any; label: string }[] = [
//     { name: 'hot', icon: <FilterX/>, label: 'Hot' },
//     { name: 'new', icon: <Newspaper />, label: 'New' },
//     { name: 'top', icon: <LucideArrowUpLeftSquare />, label: 'Top' },
//   ];
