...
//       `${process.env.NODE_BACKEND_URL}/api/libraries?page=${page}&limit=${limit}&search=${encodeURIComponent(search)}&city=${encodeURIComponent(city)}&minSeats=${minSeats}&membership=${membership}&minRating=${minRating}`,
//       {
//         headers: {
